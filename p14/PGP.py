...
str36 = "shandongdaxue202100460144huyaoyue100"
...
def generate_random_k():
    k = "".join(random.choices(str36, k=16))
...
def sender(msg):
    ...
    # 对消息加密
    enc_msg = sm4_enc.crypt_cbc(iv, msg.encode("utf-8"))
...
def receiver(enc_msg, enc_key):
    ...
    # 解密消息
    decrypt_m = crypt_sm4.crypt_cbc(iv, enc_msg)
